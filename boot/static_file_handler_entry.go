...
const (
	...
	StaticFileHandlerEntryDescription = "Internal RK entry which implements static file handler go-zero framework."
)
...
func (entry *StaticFileHandlerEntry) GetFileHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if file, err = entry.Fs.Open(p); err != nil {
			...
			httpx.WriteJson(w, http.StatusInternalServerError, rkerror.New(
